...
dependencies {
    ...
    implementation(libs.vero.chat.libraries.cryptography.api)
    ...
    testImplementation(libs.vero.chat.libraries.cryptography.test)
    testImplementation(libs.vero.chat.libraries.cryptography.impl)
