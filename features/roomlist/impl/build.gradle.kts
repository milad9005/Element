...
dependencies {
    ...
    implementation(libs.vero.chat.libraries.permissions.noop)
    ...
    api(libs.vero.chat.features.roomlist.api)
    ...
    testImplementation(libs.vero.chat.libraries.eventformatter.test)
    ...
    testImplementation(libs.vero.chat.libraries.permissions.noop)
